			...
			<div class="container p-1">
				<a class="navbar-brand text text-dark">
  				...
  				<div>
  				 ...
  				 <a href="results.jsp" class="btn btn-light" role="button" style="border-radius:20px; width:140px;">
  			 		<strong><i class="fa fa-arrow-right"></i> Quiz Results</strong>
  				 </a>
						...
						<div class="table-responsive container-fluid">
    							...
    							<tr>
        							...
        							<td><%= rs.getString(5) %></td>
       								...
       								<td><i class="fa fa-wrench text-success" aria-hidden="true"> Update</i></td>
